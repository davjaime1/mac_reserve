    ...
    <section>
        ...
        <article>
        	<table class="center">
				<tr>
					<td>
						<form name="userForm" action="/mac_reserve/FMController?action=searchForUser" method="post">
			        	<table class="center"> 
			        		<tr>
			    				<td> Username: </td>
		    			...
		    			<input style="width:163px; margin-left:90px" type="submit" value="Search for Users">
		    			</form>
			        </td>
			    </tr>
			</table>        
